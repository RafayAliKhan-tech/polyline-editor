      ...
      <div style={styles.bottomSection}>
        <div style={styles.guideBox}>
          ...
          >
            ...
            {showGuide && (
              <div style={styles.guidePopup}>
                <p><b>Select:</b> Click & select points</p>
                <p><b>Draw:</b> Create polyline</p>
                <p><b>Move:</b> Drag points</p>
                <p><b>Delete:</b> Remove points</p>
                <p><b>Insert:</b> Add point on segment</p>
                <p><b>Pan:</b> Move canvas</p>
                <p><b>Undo/Redo:</b> History</p>
                <p><b>3D:</b> Preview model</p>
              </div>
            )}
          </div>
        </div>
...
const styles = {
  ...
  guidePopup: {
    position: "absolute",
    left: "60px",        // 👈 pushes it right of sidebar
    bottom: "0px",
    width: "180px",
    background: "#2c2e33",
