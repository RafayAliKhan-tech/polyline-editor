    ...
    <div style={styles.sidebar}>
      ...
      <div style={styles.topSection}>
        ...
        <div style={styles.actionGroup}>
          <button onClick={undo} style={styles.smallBtn} title="Undo"><Undo2 size={16} /></button>
          <button onClick={redo} style={styles.smallBtn} title="Redo"><Redo2 size={16} /></button>
          <button onClick={reset} style={styles.smallBtn} title="Reset"><RotateCcw size={16} /></button>
        </div>
      </div>
